//Courtesy to nusmodifications. Makes using the API much easier.
//source: https://github.com/nusmodifications/nusmods/blob/master/scrapers/nus-v2/src/types/modules.ts

type CovidZoneId = 'A' | 'B' | 'C' | 'D' | 'E' | 'Unknown';
